...
<head>
    ...
    <title>Manajemen Verifikasi Pengguna</title>
    ...
    <div class="container-fluid d-flex">
        <div class="sidebar">
            <div class="text-center mt-4">
                <img src="{{ Auth::user()->avatar ? asset(Auth::user()->avatar) : asset('profil/avatar.png') }}" class="rounded-circle" alt="Admin profile picture" width="60" height="60">
        ...
        <div class="main-content flex-grow-1">
            <header class="d-flex justify-content-between align-items-center bg-white p-3 shadow">
                <h1 class="fs-4 page-header">Verifikasi Pengguna</h1>
            ...
            <div class="container mt-4">
                ...
                <div class="card">
                    <div class="card-header">Verifikasi Pengguna</div>
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <<td>
                                            <a href="{{ route('admin.verifikasi', ['id' => $user->id, 'status' => 'diterima']) }}" class="btn btn-success">Terima</a>
                                            <a href="{{ route('admin.verifikasi', ['id' => $user->id, 'status' => 'ditolak']) }}" class="btn btn-danger">Tolak</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
